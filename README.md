...
- gmarket 코드를 분석하며 느낀 점
  ...
  2. 페이지를 완성하고 보니 공통적으로 사용된 스타일이 많았는데 이런 부분을 묶어 공통적으로 사용하면 좋겠다는 생각이 들었습니다.

- 솔직히 완성을 거의 다 해갈쯤 그냥 자바스크립트를 나누지 말고 한파일로 관리할걸,,이라는 후회도 막심했습니다..  😂 이부분도 얼른 공부하고 싶네요
